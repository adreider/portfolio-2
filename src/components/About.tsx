  ...
  return (
    <section className="container mx-auto my-4 max-w-5xl p-4">
      ...
      <div className="mx-auto mt-20 max-w-lg">
        <div className="relative w-full rounded-lg bg-red-100 p-4 ps-20 md:h-64 md:ps-48">
            ...
            <table className="mt-4 w-full text-sm">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a
                      href="mailto:adreidereconomic@gmail.com"
                      className="underline hover:text-blue-800"
                    >
                      adriano.lino@gmail.com
                    </a>
                  </td>
                </tr>
                <tr>
          ...
          <div className="absolute -left-2 -top-4 h-24 w-20 rounded-lg bg-gray-600 bg-[url(https://i.pinimg.com/1200x/dc/49/b0/dc49b01bff28ae2f661dfd943647d7f8.jpg)] 
