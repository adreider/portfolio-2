...
function Projects() {
  ...
  return (
    <>
      <section className="rounded-tl-[80px] bg-gradient-to-tr from-blue-900 to-blue-950 text-white md:rounded-tl-[180px]">
        <div className="container mx-auto max-w-4xl p-4 py-12">
          <div className="relative p-4 text-center">
            <h2 className="relative z-50 mb-2 text-white">
              ...
              <span className="font-handwriting text-4xl text-red-400">Portfólio</span>
            </h2>
