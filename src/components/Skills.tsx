...
import { HiCodeBracketSquare } from "react-icons/hi2"
 ...
 function Skills() {
  const educations = [
    {
      name: "Curso de Desenvolvimento Web Full Stack | Rocketseat",
    },
    {
  ...
  return (
    <section className="rounded-br-[80px] bg-red-100 md:rounded-br-[180px]">
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="basis-1/2">
            <h3 className="mb-4 flex items-center gap-2 text-lg font-extrabold text-gray-700">
              <HiAcademicCap className="h-8 w-8 text-red-400" />
              Educação
            </h3>
          ...
          <div className="basis-1/2">
            <h3 className="mb-4 flex items-center gap-2 text-lg font-extrabold text-gray-700">
              <HiCodeBracketSquare className="h-8 w-8 text-red-400" />
              Skills
            </h3>
